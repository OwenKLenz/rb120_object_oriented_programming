...
# serial_number is a private getter method, but it is being called with an 
# explicit caller on line 61. To allow the call by an explicit caller within the 
# class, we should change serial_number to a protected method.